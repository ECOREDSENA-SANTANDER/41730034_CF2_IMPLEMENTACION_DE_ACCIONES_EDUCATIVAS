  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
          ...
          .col-sm-12.col-lg-8
            SlyderF.mb-5(columnas="col-lg-6 col-xl-6")
              ...
              .tarjeta.bg-fondo-9.p-3.p-md-3.p-lg-5
                ...
                p.mb-0.text-center Acciones destinadas a la mejora continua de las condiciones de vida de la población, incluyendo intervenciones en saneamiento básico, promoción de la salud, educación ambiental, y participación comunitaria.

              .tarjeta.bg-fondo-9.p-3.p-md-3.p-lg-5
                .row.align-items-center.my-4.justify-content-center.hide-icon-sm
                    .col-sm-12.col-md-3.col-lg-5
                        img(src='@/assets/curso/temas/t3/14.svg', alt='')
                p.mb-0.text-center Fomentar la articulación intersectorial entre diferentes actores (gobierno, comunidad, sector privado, organizaciones sociales), asegurando la cooperación y el compromiso colectivo para el logro de los objetivos.
    ...
    .tarjeta--container.row.mb-4(data-aos="fade-left")
      .col-md.tarjeta.p-3
        .row.justify-content-center.mb-0
          .col-12.border-right-cus
            .row.align-items-end.justify-content-start.mb-2
              .col-lg-2.mb-0.d-none.d-lg-block
                img(src='@/assets/curso/temas/t3/15.svg')
            p.mb-2 Un cronograma detallado de las actividades, con plazos concretos para cada fase de implementación.
      .col-md.tarjeta.p-3
        .row.justify-content-center.mb-0
          .col-12
            .row.align-items-end.justify-content-start.mb-2
            ...
            p.mb-2  La clara asignación de roles y responsabilidades entre los diferentes actores involucrados, asegurando la corresponsabilidad y la participación activa de las comunidades.
      ...
      .col-md.tarjeta.p-3
        .row.justify-content-center.mb-0
          .col-12.border-right-cus
            ...
            p.mb-2 La planificación presupuestaria que asegure la disponibilidad de los recursos humanos, técnicos y financieros necesarios.
      .col-md.tarjeta.p-3
        .row.justify-content-center.mb-0
          .col-12
            .row.align-items-end.justify-content-start.mb-2
            ...
            p.mb-2 Mecanismos para el seguimiento y evaluación del uso de los recursos, con enfoque en la transparencia y rendición de cuentas.
    .row.align-items-center.mb-4.titulo-icono(data-aos="fade-left")
      .col-auto.titulo-icono-img
        img(src='@/assets/bg/2.svg', alt='')
      .col
    ...
    .row.justify-content-center.mb-5(data-aos="fade-left")
      .col-sm-12.col-lg-4
        .tarjeta--boton-2.bg-fondo-12.p-4.mb-cus
          ...
          p.text-center.mb-0 Estrategias que promuevan la participación activa de la comunidad en todas las etapas del plan (diagnóstico, diseño, implementación y evaluación).
      .col-sm-12.col-lg-4
        .tarjeta--boton-2.bg-fondo-12.p-4.mb-cus
          .row.justify-content-center.mb-3.d-none.d-lg-block
            .col-3.m-auto
              figure
                img(src='@/assets/curso/temas/t3/20.svg')
          p.text-center.mb-0  Fortalecimiento de las capacidades locales para garantizar la sostenibilidad de las acciones una vez finalizado el proyecto.
      .col-sm-12.col-lg-4
        .tarjeta--boton-2.bg-fondo-12.p-4.mb-cus
          .row.justify-content-center.mb-3.d-none.d-lg-block
            .col-3.m-auto
      ...
      .col-md.tarjeta.bg-fondo-14.p-4.p-md-4.p-lg-5.mb-cus
        .row.justify-content-center.mb-1
          .col-12
            .row.align-items-end.justify-content-start
              .col-lg-3.mb-4.d-none.d-lg-block
                img.img-a.img-t(src='@/assets/curso/temas/t3/26.svg')
            p.mb-2.text-white Porcentaje de entornos priorizados (viviendas, instituciones educativas, espacios públicos y lugares de trabajo) en el territorio seleccionado que han sido caracterizados según los criterios de la EES.
      .col-md.tarjeta.bg-fondo-15.p-4.p-md-4.p-lg-5 
        .row.justify-content-center.mb-1
          .col-12
            .row.align-items-end.justify-content-start
    ...
    ul.lista-ul.lista-ul--separador(data-aos="fade-left")
      li.d-flex
        ...
        p.mb-0  Porcentaje de entornos priorizados donde se han implementado acciones de mejora bajo la EES.
      ...
      li.d-flex
        i.fas.fa-check-circle.bg-color-3
        p.mb-0   Número de proyectos intersectoriales (salud, educación, ambiente, infraestructura) ejecutados en los entornos priorizados bajo la estrategia EES.

      li.d-flex
        i.fas.fa-check-circle.bg-color-3
        p.mb-0  Porcentaje de proyectos de mejora implementados que continúan en funcionamiento y han sido verificados en los procesos de seguimiento (mediciones al inicio, medio término y finalización del proyecto).

      li.d-flex
        i.fas.fa-check-circle.bg-color-3
        p.mb-0  Número de espacios de articulación intersectorial (comités, mesas técnicas, grupos de trabajo) activos que impulsan la implementación de la EES.
